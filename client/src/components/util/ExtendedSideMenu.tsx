...
import { CaretLeft, CaretRight, Carrot } from "@phosphor-icons/react"
...
const ExtendedSideMenu: React.FC = () => {
    ...
    return (
        <div
            className={`fixed z-20 ${!show && "md:-translate-x-[92px]"} top-19 flex h-full items-center transition duration-200 md:left-[92px]`}
        >
            <div
            ...
            <button
                ...
                className={`hover:bg-DarkGreen relative -z-10 mb-40 flex h-16 w-6 items-center justify-center rounded-r-2xl bg-gray-50 py-10 text-gray-500 shadow-[0_0_8px_rgba(0,0,0,0.25)] transition duration-200 select-none hover:border-white hover:text-white`}
            >
