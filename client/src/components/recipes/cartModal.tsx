...
import { ForkKnife, Minus } from "@phosphor-icons/react"
                        ...
                        recipesInPlan.map((recipePlan, index) => (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="flex flex-row items-center">
                                        ...
                                        <p className="ml-2 text-sm font-medium text-[#2D3748]">
                                            {recipePlan.recipe?.TotalKcal?.toFixed(
                                                0,
                                            ) ?? 0}
                                            kcal
                                        </p>
                                    ...
                                    <div className="flex flex-row items-center">
                                        ...
                                        />
                                        <p className="ml-2 text-sm font-medium text-[#2D3748]">
                                            {recipePlan.recipe.TotalProtein?.toFixed(
                                                0,
                                            ) ?? 0}
                                            g
                                        </p>
                                    ...
                                    <div className="flex flex-row items-center">
                                        ...
                                        />
                                        <p className="ml-2 text-sm font-medium text-[#2D3748]">
                                            {recipePlan.recipe?.TotalFat?.toFixed(
                                                0,
                                            ) ?? 0}
                                            g
                                        </p>
                                    ...
                                    <div className="flex flex-row items-center">
                                        ...
                                        />
                                        <p className="ml-2 text-sm font-medium text-[#2D3748]">
                                            {recipePlan.recipe?.TotalCarbohydrates?.toFixed(
                                                0,
                                            ) ?? 0}
                                            g
                                        </p>
                                ...
                                <button
                                    ...
                                    onClick={() => removeRecipeFromPlan(index)}
                                >
                                    Remove Meal{" "}
                                    <Minus
                                        className="ml-2"
