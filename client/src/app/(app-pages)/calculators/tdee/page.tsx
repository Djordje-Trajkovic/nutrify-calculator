...
import { tdeeCalculatorConfig } from "@/utils/calculatorConfigs"
...
export default function TDEECalculatorPage() {
    ...
    const handleCalculate = () => {
        const calculationResult = tdeeCalculatorConfig.calculate(inputs)
        ...
        <AppContainer>
            <Box sx={{ minHeight: "100vh", paddingY: 4 }}>
                <Box sx={{ marginBottom: 4, textAlign: "center" }}>
                    ...
                    >
                        {view === "form"
                            ? tdeeCalculatorConfig.description
                            : "Calculation Results"}
                    </Typography>
                </Box>
                ...
                {view === "form" ? (
                    <CalculatorForm
                        fields={tdeeCalculatorConfig.fields}
                        inputs={inputs}
                        onInputChange={handleInputChange}
                        onCalculate={handleCalculate}
                        calculatorName={tdeeCalculatorConfig.name}
                    />
                ) : (
                    result && (
                        <CalculatorResults
