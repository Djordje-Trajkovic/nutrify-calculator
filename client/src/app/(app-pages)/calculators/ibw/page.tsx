...
import { ibwCalculatorConfig } from "@/utils/calculatorConfigs"
...
export default function IBWCalculatorPage() {
    ...
    const handleCalculate = () => {
        const calculationResult = ibwCalculatorConfig.calculate(inputs)
        ...
        <AppContainer>
            <Box sx={{ minHeight: "100vh", paddingY: 4 }}>
                <Box sx={{ marginBottom: 4, textAlign: "center" }}>
                    ...
                    >
                        {view === "form"
                            ? ibwCalculatorConfig.description
                            : "Calculation Results"}
                    </Typography>
                </Box>
                ...
                {view === "form" ? (
                    <CalculatorForm
                        fields={ibwCalculatorConfig.fields}
                        inputs={inputs}
                        onInputChange={handleInputChange}
                        onCalculate={handleCalculate}
                        calculatorName={ibwCalculatorConfig.name}
                    />
                ) : (
                    result && (
                        <CalculatorResults
