...
import { bmiCalculatorConfig } from "@/utils/calculatorConfigs"
...
export default function BMICalculatorPage() {
    ...
    const handleCalculate = () => {
        const calculationResult = bmiCalculatorConfig.calculate(inputs)
        ...
        <AppContainer>
            <Box sx={{ minHeight: "100vh", paddingY: 4 }}>
                ...
                <Box sx={{ marginBottom: 4, textAlign: "center" }}>
                    ...
                    >
                        {view === "form"
                            ? bmiCalculatorConfig.description
                            : "Calculation Results"}
                    </Typography>
                </Box>
                ...
                {view === "form" ? (
                    <CalculatorForm
                        fields={bmiCalculatorConfig.fields}
                        inputs={inputs}
                        onInputChange={handleInputChange}
                        onCalculate={handleCalculate}
                        calculatorName={bmiCalculatorConfig.name}
                    />
                ) : (
                    result && (
                        <CalculatorResults
